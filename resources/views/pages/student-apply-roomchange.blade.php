      ...
      <form accept-charset="UTF-8" action="/" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_bQQaTxnaZlzv4FnnuZ28LFHccVSaj" id="payment-form" method="post">
        ...
        <div class='form-row'>
          <div class='col-xs-12 form-group'>
            <label class='control-label col-xs-4'>Current Room  </label>
            <input class="col-xs-4-offset-3" autocomplete='off'  size='10' type='text'>
          </div>
        ...
        <div class='form-row'>
          <div class='col-xs-12 form-group'>
            <label class='control-label col-xs-4'>Desired Room    </label>
            <input class="col-xs-4-offset-3" autocomplete='off'  size='10' type='text'>
          </div>
        ...
        <div class='form-row'>
          <div class='col-xs-12 form-group'>
            <label class='control-label'>Application<br></br></label>

            <textarea class='form-control' name="message" rows="10" cols="30" placeholder="Write your application here..."></textarea>
          </div>
